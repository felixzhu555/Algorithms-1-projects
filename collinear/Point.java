...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        /**
         * compare slopes of two points with respect to this point
         *
         * @param that1
         * @param that2
         * @return -1 if that1 < that2, 0 if equal, 1 if that1 > that 2
         */
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("p and q: " + p.slopeTo(q));
        StdOut.println("p and r: " + p.slopeTo(r));
        StdOut.println("p and s: " + p.slopeTo(s));
